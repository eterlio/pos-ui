...
const StockCard: FC<StockCardProps> = ({ product, stock: { quantityExpected = 0, quantityReceived = 0, status, batchId } }) => {
  return (
    <div className="mb-2 rounded border-[1.8px] p-4 border-primary min-h-[200px] flex flex-col">
      ...
      <div className="flex items-center justify-center flex-1 flex-col mt-3">
        ...
        <div className="text-[12px] text-gray-500">{startCase(status)}</div>
